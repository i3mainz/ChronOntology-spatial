...
var HeatmapOverlay = L.Class.extend({
  ...
  getData: function(e) {
		...
		//console.log(this._heatmap._store._min);
		//console.log(this._heatmap._store._max);
		//console.log(this._heatmap);
		console.info(e.latlng.lat + ":" + e.latlng.lng + " " + this._heatmap.getValueAt({ x: e.latlng.lat, y: e.latlng.lng }));
  },
